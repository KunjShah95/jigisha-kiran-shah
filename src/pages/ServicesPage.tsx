    ...
    jsonLd: [
      {
        ...
        itemListElement: [
          { '@type': 'ListItem', position: 1, name: 'Term Life Insurance', url: 'https://jigisha-kiran-shah.vercel.app/services' },
          { '@type': 'ListItem', position: 2, name: 'Retirement & Pension Planning', url: 'https://jigisha-kiran-shah.vercel.app/services' },
          { '@type': 'ListItem', position: 3, name: 'Child Education Plans', url: 'https://jigisha-kiran-shah.vercel.app/services' },
          { '@type': 'ListItem', position: 4, name: 'Wealth Creation & Endowment', url: 'https://jigisha-kiran-shah.vercel.app/services' },
          { '@type': 'ListItem', position: 5, name: 'Health Insurance', url: 'https://jigisha-kiran-shah.vercel.app/services' },
          { '@type': 'ListItem', position: 6, name: 'Corporate & HUF Insurance', url: 'https://jigisha-kiran-shah.vercel.app/services' },
        ],
      },
    ],
  })
