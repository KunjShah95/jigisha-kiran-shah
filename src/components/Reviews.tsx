...
const Reviews = () => {
  ...
  const customerReviews = [
    ...
    },
    {
      ...
      rating: 5,
      date: 'July 2024',
      useCase: 'Pension Planning',
      challenge: 'Securing pension funds',
      solution: 'Dedicated pension policy',
    ...
    },
    {
      ...
      date: 'December 2024',
      useCase: 'Family Protection',
      challenge: 'Securing child\'s future',
      solution: 'Education and Marriage plans',
      text: 'Extremely happy with the service. Jigisha Ben is very professional and her advice on family protection was invaluable. She made the entire process of choosing LIC plans very smooth and clear.',
      source: 'Google',
      tag: 'Child Education'
    },
    {
