...
const Hero = () => {
  return (
    <section className="hero relative overflow-hidden flex items-center bg-transparent py-8 lg:py-0 lg:min-h-[95vh]">
      ...
      <div className="container relative z-10 w-full pt-28 lg:pt-32 pb-12 lg:pb-16">
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-16 items-center">
          {/* Content Column */}
          <div className="lg:col-span-7 hero__content reveal">
            <div className="flex flex-wrap items-center gap-2 mb-4 lg:mb-6">
              <span className="inline-flex items-center gap-2 px-3 py-1.5 lg:px-5 lg:py-2 rounded-full bg-white border border-gold/30 shadow-md hover:shadow-lg transition-shadow duration-300">
                <Award className="w-3.5 h-3.5 lg:w-5 lg:h-5 text-gold fill-gold" aria-hidden="true" />
                <span className="text-[11px] lg:text-sm font-bold text-midnight tracking-wide uppercase">2 Times MDRT Achiever 2023 & 2024</span>
              </span>
              <span className="inline-flex items-center px-3 py-1.5 rounded-full bg-gold/10 border border-gold/30 text-[11px] lg:text-xs font-semibold text-gold-dark tracking-wide">
                Your Wealth, Your Legacy, Our Expertise
              </span>
            </div>
            ...
            <p className="text-base lg:text-xl text-gray-600 mb-6 lg:mb-8 max-w-xl leading-relaxed font-light">
              Trusted by <strong className="text-midnight font-semibold">2,700+ families</strong> for comprehensive retirement planning and life insurance strategies. Rated <strong className="text-gold-dark font-semibold">5.0 ★ on Google</strong> — Get expert guidance for your family's future.
            </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 lg:gap-6 py-6 border-t border-gray-200/60 w-full">
              ...
              <div className="reveal-scale group cursor-default" style={{ transitionDelay: '0.8s' }}>
                <div className="flex items-center gap-1.5 lg:gap-2 mb-0.5">
                  <Award className="w-4 h-4 lg:w-5 lg:h-5 text-gold" aria-hidden="true" />
                  <div className="text-xl lg:text-3xl font-bold text-midnight">MDRT</div>
                </div>
                <div className="text-[11px] lg:text-xs text-gray-500 uppercase tracking-widest font-semibold">2023 & 2024</div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 relative mt-4 lg:mt-8 reveal-right block">
            <div className="relative w-full aspect-4/5 max-w-sm lg:max-w-md mx-auto">
              ...
              <div aria-hidden="true" className="absolute inset-0 rounded-3xl lg:rounded-4xl border-2 border-gold/20 rotate-3 scale-105 z-0" />
              <div aria-hidden="true" className="absolute inset-0 rounded-3xl lg:rounded-4xl border border-midnight/5 -rotate-2 scale-105 z-0" />
              ...
              <div className="relative h-full w-full rounded-3xl lg:rounded-4xl overflow-hidden shadow-2xl z-10 group">
                ...
                <div aria-hidden="true" className="absolute inset-0 bg-linear-to-t from-midnight/90 via-midnight/20 to-transparent opacity-80" />
                ...
                <div className="absolute bottom-0 left-0 right-0 p-5 lg:p-8 text-white transform translate-y-2 group-hover:translate-y-0 transition-transform duration-500">
                  <div className="bg-gold px-3 py-0.5 lg:px-4 lg:py-1 self-start inline-block rounded-md text-[11px] lg:text-xs font-bold text-white uppercase tracking-wider mb-2 lg:mb-3">
                    Senior Advisor
                  </div>
                  <div className="font-display text-xl lg:text-3xl font-bold mb-0.5 lg:mb-1">Jigisha Kiran Shah</div>
                  <p className="text-white/80 text-xs lg:text-sm font-medium">Expert Financial guidance for 2 decades</p>
                </div>
              </div>

              {/* Floating Trust Badge */}
              <div className="absolute -top-4 lg:-top-6 right-2 lg:-right-2 bg-white/95 backdrop-blur-md p-4 lg:p-5 rounded-xl shadow-xl border border-white/40 max-w-[180px] lg:max-w-[200px] animate-float z-20 hidden md:block">
                <div className="flex gap-1 text-gold mb-1 lg:mb-2" aria-hidden="true">
                  {[1, 2, 3, 4, 5].map(i => <Star key={i} className="w-3 h-3 fill-current" />)}
                </div>
                <p className="text-[11px] lg:text-xs text-gray-700 font-medium leading-relaxed italic">
