          ...
          <div className="relative reveal-left">
            <div className="relative rounded-3xl overflow-hidden shadow-2xl aspect-4/5 border border-gray-100 group">
              ...
              <div className="absolute bottom-0 left-0 w-full p-8 z-20">
                 ...
                 <h3 className="text-3xl font-playfair font-bold text-white mb-2">Jigisha Kiran Shah</h3>
                 <p className="text-white/80 uppercase tracking-widest text-xs font-medium">Senior Wealth Advisor • Double MDRT</p>
              </div>
            </div>

            <div className="absolute -bottom-10 -right-10 bg-white p-8 rounded-3xl shadow-xl border border-gray-100 z-30 hidden lg:block animate-float">
              <div className="flex items-start gap-4">
                 <div className="text-5xl font-bold font-playfair text-midnight">22<span className="text-gold">+</span></div>
                 <div className="text-xs font-bold text-gray-500 uppercase tracking-wider leading-relaxed mt-2">Years of<br/>Excellence</div>
              </div>
            </div>
          </div>

          <div className="reveal-right">
            <div className="inline-block px-3 py-1 bg-midnight/5 text-midnight text-xs font-bold tracking-[0.2em] uppercase rounded-full mb-6 border border-midnight/10">The Legacy of Trust</div>
