      ...
      <div className="container relative z-10 w-full">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          <div className="relative reveal-left text-white lg:pt-6">
            ...
            <div className="absolute -bottom-6 -right-6 lg:-bottom-10 lg:-right-10 bg-white/90 backdrop-blur-md p-6 lg:p-8 rounded-3xl shadow-xl border border-gold/20 z-30 hidden md:block animate-float">
